(async () => {
    ...
    n.remove();
            ...
            if (!window.location.pathname.split('/').includes('lobby')) return alert('You must be in a game lobby! This is where you are picking your Blook before joining a game. (e.g. https://www.blooket.com/play/lobby)');
